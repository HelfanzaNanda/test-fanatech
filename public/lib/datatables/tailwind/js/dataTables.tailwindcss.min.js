...
$.extend( DataTable.ext.classes, {
	sWrapper:      "text-sm dataTables_wrapper dt-tailwindcss",
	sFilterInput: "!inline-block float-right text-end text-sm border placeholder-gray-500 ml-2 px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500 dark:placeholder-gray-400",
	sLengthSelect: "!inline-block text-sm border px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500",
	sProcessing:   "text-sm dt-processing uk-panel",
	tailwindcss: {
		paging: {
			active: 'text-sm font-semibold bg-gray-100 dark:bg-gray-700/75',
			notActive: 'text-sm bg-white dark:bg-gray-800',
			button: 'text-sm relative inline-flex justify-center items-center space-x-2 border px-4 py-2 -mr-px leading-6 hover:z-10 focus:z-10 active:z-10 border-gray-200 active:border-gray-200 active:shadow-none dark:border-gray-700 dark:active:border-gray-700',
			first: 'text-sm rounded-l-lg',
			last: 'text-sm rounded-r-lg',
			enabled: 'text-sm text-gray-800 hover:text-gray-900 hover:border-gray-300 hover:shadow-sm focus:ring focus:ring-gray-300 focus:ring-opacity-25 dark:text-gray-300 dark:hover:border-gray-600 dark:hover:text-gray-200 dark:focus:ring-gray-600 dark:focus:ring-opacity-40',
			notEnabled: 'text-sm text-gray-300 dark:text-gray-600'
		},
		table: 'text-sm dataTable w-full text-sm align-middle whitespace-nowrap',
		thead: {
