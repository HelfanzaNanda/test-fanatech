    ...
    <script>
        ...
        function drawDatatable(){
            $("#main-table").DataTable({
                ...
                "ajax": {
                    "url": `${APP_URL}/api/purchase/datatables`,
                ...
                "columns": [
                    ...
                    {
                        visible : ['SUPERADMIN', 'PURCHASE'].includes(GLOBAL_ROLE_NAME), title : 'Action', data: null, name: 'action', orderable: false, width: '9%', render : (data, type, row, meta) => {
                            let action = ``
        ...
        function format(d) {
            ...
            children += `    </thead>`;
            children += `    <tbody>`;
                                d.purchase_details.forEach((item, index) => {
            children += `            <tr>`;
        ...
        $(document).on('click', '.btn-create', async function (e) {
            e.preventDefault()
            const url = `${APP_URL}/purchase/create`;
            location.href = url;
        })
        ...
        $(document).on('click', '.btn-edit', async function (e) {
            ...
            const url = `${APP_URL}/purchase/${id}/edit`;
            location.href = url;
        })
